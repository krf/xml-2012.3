...
\begin{lstlisting}[caption=Methoden aus interface.py]
...
Nachdem die Grundfunktionalität der Anwendung gegeben war, wurde die Anreicherung von Microdata durch inkrementelle Erweiterung der XSLT
...
\begin{center}
http://kuonrat.userpage.fu-berlin.de/default-2012-06-28-15-26-57.zip [373 MB]
\end{center}

Dieser beinhaltet 55.823 Tracks wovon 1.696 keine POIs haben, d.h. für die wurde nichts im Umkreis gefunden. Zunächst muss der Datenbankdump (\emph{default-*.zip}) nach \emph{\$HOME/BaseXData/} kopiert werden um sie später importieren zu können.
