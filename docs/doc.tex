...
Die benötigte HTML Seiten werden ausschließlich dynamisch durch serverseitige XSL Transformationen konstruiert und an den Anwender übertragen. Während der Transformation werden die Webseiten mit Microdata erweitert um die Routeninformationen und POIs maschinenlesbar zu machen.
...
XSL Transformation wurde zudem nicht nur für die nutzerseitigen HTML Seiten verwendet, sondern auch für weiteres Aufbereiten der Daten.
